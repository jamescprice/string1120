...
///  printf("IN NEXT_TOKEN ");
  ...
  if(isdigit(current_char))
    ...
    case 118: make_token(TimesToken); break;
...
//    case '\xA3': make_token(DivideToken); break; //hex A3
    ...
    case 'z': make_token(DummyToken); break;
...
//Token t;
  ...
  switch(t)
    ...
    case TimesToken: putchar(' ');putchar('*');putchar(118); break;
    case DivideToken: putchar(' '); putchar('/'); putchar(163); break;
    case LeftParenToken: putchar(' '); putchar('('); break;
    case RightParenToken: putchar(' ');putchar(')'); break;
    case DummyToken: putchar(' ');putchar('z'); break;
